...
<h3>게시글 수정</h3>
<hr/>
<form id="frm" action="${contextPath }/board/osModi.do" method="post" >
<table width="70%" align="center">
        <tr>
            <td>제목</td>
            <td><input type="text" id="title" name="title" value="${article.title }" style="width:650px"/></td>
        </tr>
        <tr>
        	<td>아이디</td>
        ...
        <tr>
            <td>내용</td>
            <td>
                <textarea rows="10" cols="30" id="ir1" name="content" style="width:650px; height:350px;">${article.title }
                </textarea>
            </td>
        </tr>
        <tr>
