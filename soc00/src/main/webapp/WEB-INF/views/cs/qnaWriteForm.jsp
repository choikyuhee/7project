...
<h3>글쓰기</h3>
<hr/>
<form id="frm" action="${contextPath }/cs/qnaWrite.do" method="post" >
<table width="70%" align="center">
        <tr>
            <td>제목</td>
            <td><input type="text" id="title" name="q_title" style="width:650px"/></td>
        </tr>
        <tr>
        	<td>아이디</td>
        ...
        <tr>
            <td>내용</td>
            <td>
                <textarea rows="10" cols="30" id="ir1" name="q_content" style="width:650px; height:350px; "></textarea>
            </td>
        </tr>
        <tr>
